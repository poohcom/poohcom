...
(function (Chameleon) {
    ...
    })(TextureInUse = Chameleon.TextureInUse || (Chameleon.TextureInUse = {}));
    /**
    ...
    class TextureManager {
        ...
        constructor(mesh, renderer, camera) {
        ...
        _updateViewingFromDrawingTexture() {
            if (this._affectedFaces.length > 0) {
                ...
                this._affectedFaces.forEach((faceIndex) => {
                    ...
                    for (var j = 0; j < 3; j += 1) {
                        ...
                        viewingUvs[j].setX((drawingUV.x - uMin) * (this._drawingCanvas.width) / patchCanvas.width).setY((drawingUV.y - vMin) * (this._drawingCanvas.height) / patchCanvas.height);
                    }
                });
        ...
        _isFaceAffectedByStroke(faceIndex, strokeCenter, strokeRadius, strokeStarts) {
        ...
        _recordAffectedFaces(faceIndex, strokeCenter, strokeRadius, strokeStarts) {
        ...
        onStrokePainted(canvasPos, radius, strokeStarts) {
