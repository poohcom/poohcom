...
var DecalGeometry2 = function ( mesh, position, orientation, size ) {
	...
	this.addAttribute( 'uv3', new Float32BufferAttribute( uvs3, 2 ) );
	...
	function pushDecalVertex( decalVertices, vertex, normal, uv ) {
		...
		decalVertices.push( new DecalVertex( vertex.clone(), normal.clone(), uv.clone() ) );
	...
	function clip( v0, v1, p, s ) {
		...
		var v = new DecalVertex(
			...
			new Vector2(
				v0.uv.x + s0 * ( v1.uv.x - v0.uv.x ),
				v0.uv.y + s0 * ( v1.uv.y - v0.uv.y )
			)
		);
...
DecalGeometry2.prototype = Object.create( BufferGeometry.prototype );
DecalGeometry2.prototype.constructor = DecalGeometry2;

// helper

var DecalVertex = function ( position, normal, uv ) {
...
DecalVertex.prototype.clone = function () {
	...
	return new this.constructor( this.position.clone(), this.normal.clone(), this.uv.clone() );

};

export { DecalGeometry2, DecalVertex };
