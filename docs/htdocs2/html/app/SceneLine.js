...
export class SceneLine {
    ...
    OnClick() {
        ...
        if (this.clickName == "line_a_button") {
            ...
            ModelManager.Instance.shoelace_UP.material = ModelManager.Instance.GetMaterial(ModelManager.Instance.nike_shoelace_BC_WH, ModelManager.Instance.nike_shoelace_N);
        }
        if (this.clickName == "line_b_button") {
            ...
            ModelManager.Instance.shoelace_DOWN.visible = false;
            ModelManager.Instance.shoelace_UP.visible = true;
            ModelManager.Instance.shoelace_UP.material = ModelManager.Instance.GetMaterial(ModelManager.Instance.nike_shoelace_BC_BK, ModelManager.Instance.nike_shoelace_N);
        }
        if (this.clickName == "line_c_button") {
            ...
            ModelManager.Instance.shoelace_UP.visible = false;
            ModelManager.Instance.shoelace_DOWN.material = ModelManager.Instance.GetMaterial(ModelManager.Instance.nike_shoelace_BC_WH, ModelManager.Instance.nike_shoelace_N);
        }
        if (this.clickName == "line_d_button") {
            ...
            ModelManager.Instance.shoelace_DOWN.visible = true;
            ModelManager.Instance.shoelace_UP.visible = false;
            ModelManager.Instance.shoelace_DOWN.material = ModelManager.Instance.GetMaterial(ModelManager.Instance.nike_shoelace_BC_BK, ModelManager.Instance.nike_shoelace_N);
        }
    }
    Exit() {
        ModelManager.Instance.ClearButton();
