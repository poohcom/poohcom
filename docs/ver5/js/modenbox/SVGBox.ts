...
class SVGBox
{
    ...
    public pointMap: Dictionary<string, BoxPoint>;
    public lineMap: Dictionary<string, BoxLine>;
    public graphMap: Dictionary<string, BoxLine[]>;
    public faceMap: Dictionary<string, BoxFace>;
    public baselineMap: Dictionary<string, BoxBaseline>;
    ...
    public init(doc: Document): void {
        ...
        this.pointMap = new Dictionary<string, BoxPoint>();
        this.lineMap = new Dictionary<string, BoxLine>();
        this.graphMap = new Dictionary<string, BoxLine[]>();
        this.faceMap = new Dictionary<string, BoxFace>();
        this.baselineMap = new Dictionary<string, BoxBaseline>();
    ...
    private addBoxChildList(): void {
        ...
        var listBoxFace: Dictionary<number, BoxFace> = new Dictionary<number, BoxFace>();
