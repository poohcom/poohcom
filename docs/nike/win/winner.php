...
<div id="wrap">
	...
	<div class="table">
		...
		<div class="content winner">
			<div class="txt">
				<img src="images/img_content2.png" alt="FIGURE KIT 당첨자 확인 - 이벤트에 응모하신 전화번호를 입력해주세요">
			</div>
			<div class="box">
				<div class="insert">
					<label><input id="name" type="text" placeholder="이름 입력"></label>
				</div>
				<div class="insert insert_address">
					<label><input type="text" disabled></label>
					<a href="javascript:mydaum()">주소 검색</a>
				</div>
				<div class="insert">
					<label><input id="address1" type="text" placeholder="자동 주소 입력" disabled></label>
				</div>
				<div class="insert">
					<label><input id="address2" type="text" placeholder="나머지 주소"></label>
				</div>
				<div class="chk">

					<div class="collect_agree" onclick="popOpen('.pop-collectagree');">
						<img src="images/img_content2_agree.png" alt="이벤트 안내를 위한 개인 정보 수집에 동의합니다. (필수)">
					</div>
				</div>
			</div>
			<div class="btn_area">
...
<!-- 팝업 - 키트 -->
<div class="popup pop-fin">
	<div class="pop-cont">
		<div class="inner">
			<div class="bg">
				<h2><img src="images/img_logo.png" alt=""></h2>
				<img src="images/img_pop_content2.png" alt="">
...
<div class="popup pop-collectagree">
	<div class="pop-cont">
		<div class="inner">
			<div class="bg">
				<h2><img src="images/img_logo.png" alt=""></h2>
				<img src="images/img_pop_content2_agree_text.png" alt="">
				<div class="textarea">
				<!-- 수정 -->
				...
				<div class="checkbox-area">
					...
					<label for="collectAgree"><img src="images/img_pop_content2_agree.png" alt="이벤트 참여를 위한 상기내용에 동의합니다."></label>
				</div>
			</div>
		</div>
	</div>
