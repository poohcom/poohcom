    ...
    public updateTime(time: number):void
    {
        ...
        switch (this.type)
        {
            case AnimationType.TRANSFORM:
                ...
                {
                    this.oldPos.x = (<THREE.Object3D>(this.target)).position.x;
                    this.oldPos.y = (<THREE.Object3D>(this.target)).position.y;
                    this.oldPos.z = (<THREE.Object3D>(this.target)).position.z;
                ...
                } else if (time > this.endTime || this.durationTime==0)
                {
                    ...
                    (<THREE.Object3D>(this.target)).position.z = this.z;
                        ...
                        (<THREE.Object3D>(this.target)).rotation.x = this.rx;
    
                        (<THREE.Object3D>(this.target)).rotation.y = this.ry;
    
                        (<THREE.Object3D>(this.target)).rotation.z = this.rz;
    
                    (<THREE.Object3D>(this.target)).updateMatrix();

                } else {

                    var r: number = (time - this.startTime) / this.durationTime;

                        (<THREE.Object3D>(this.target)).rotation.x = this.rx * r;
    
                        (<THREE.Object3D>(this.target)).rotation.y = this.ry * r;
    
                        (<THREE.Object3D>(this.target)).rotation.z = this.rz * r;
                    ...
                    if (this.moveHeight > 1.0)
                    {
                        ...
                        if (r < 0.3) {
                            r = r / 0.3;
                            (<THREE.Object3D>(this.target)).position.x = this.oldPos.x;
                            (<THREE.Object3D>(this.target)).position.y = this.oldPos.y;
                            (<THREE.Object3D>(this.target)).position.z = this.z + r * this.moveHeight;
                            ...
                            (<THREE.Object3D>(this.target)).position.z = this.z + (1 - r) * this.moveHeight;
                        } else {
                            r = (r - 0.3) / 0.4;
                            
                            (<THREE.Object3D>(this.target)).position.x = this.oldPos.x + (this.x - this.oldPos.x) * r;
                            (<THREE.Object3D>(this.target)).position.y = this.oldPos.y + (this.y - this.oldPos.y) * r;
                            (<THREE.Object3D>(this.target)).position.z = this.z + this.moveHeight;
                        }
